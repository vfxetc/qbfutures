# -*- coding: utf-8 -*-
#
# qbfutures documentation build configuration file, created by
...
htmlhelp_basename = 'qbfuturesdoc'
...
latex_documents = [
  ('index', 'qbfutures.tex', u'qbfutures Documentation',
   u'Western X', 'manual'),
]
...
man_pages = [
    ('index', 'qbfutures', u'qbfutures Documentation',
     [u'Western X'], 1)
]
...
texinfo_documents = [
  ('index', 'qbfutures', u'qbfutures Documentation',
   u'Western X', 'qbfutures', 'One line description of project.',
   'Miscellaneous'),
]
